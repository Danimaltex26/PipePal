...
const SPECIALTIES = [
  'Residential', 'Commercial', 'Industrial', 'Service & Repair',
  'New Construction', 'Gas Piping', 'Hydronic / Radiant', 'Steam Systems',
  'Medical Gas', 'Fire Protection', 'Backflow Testing', 'Green / Sustainable',
];

const CERTIFICATIONS = [
  'Apprentice Plumber', 'Journeyman Plumber', 'Master Plumber',
  'Backflow Tester (ASSE)', 'Medical Gas Installer (ASSE 6010)',
  'NITC Pipefitter', 'NITC Steamfitter',
  'OSHA 10', 'OSHA 30', 'Other',
];
  ...
  const usageBar = (used, limit) => {
    ...
    return (
      <div style={{ background: 'rgba(255,255,255,0.08)', borderRadius: 4, height: 8, overflow: 'hidden', marginTop: 4 }}>
        <div style={{ width: `${pct}%`, height: '100%', background: '#3B82F6', borderRadius: 4, transition: 'width 0.3s' }} />
      </div>
    );
  };
      ...
      {isFree && (
        <div className="card">
          ...
          <div className="stack-sm">
            <div>
              <div className="row-between"><span>Plumbing Analyses</span><span>{usage.plumbing_analyses || 0}/2</span></div>
              {usageBar(usage.plumbing_analyses || 0, 2)}
            </div>
            <div>
