    ...
    <div className="page" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', minHeight: '100dvh', padding: '1.5rem', maxWidth: 420, margin: '0 auto', width: '100%' }}>
        <div className="stack">
          <div className="text-center">
            <img src="/logo.png" alt="PipePal" style={{ width: 260, marginBottom: '0.5rem', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="stack">
              ...
              <label style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5rem', fontSize: '0.8125rem', color: '#A0A0A8', cursor: 'pointer', lineHeight: 1.5 }}>
                <input type="checkbox" checked={agreedToTerms} onChange={(e) => setAgreedToTerms(e.target.checked)} style={{ marginTop: 3, flexShrink: 0, accentColor: '#3B82F6' }} />
                <span>
                  I agree to the{' '}
                  <a href="https://tradepals.net/pipepal/terms" target="_blank" rel="noopener noreferrer" style={{ color: '#3B82F6' }}>Terms of Service</a>{' '}
                  and{' '}
                  <a href="https://tradepals.net/pipepal/privacy" target="_blank" rel="noopener noreferrer" style={{ color: '#3B82F6' }}>Privacy Policy</a>.
                </span>
              </label>
