...
export default function HistoryPage() {
  ...
  const fetchHistory = async () => {
    ...
    try {
      ...
      setAnalyses(data.plumbing_analyses || []);
        ...
        <div className="expandable-header" onClick={() => toggle(item.id)}>
          <div style={{ flex: 1 }}>
            <div className="row-between">
              <strong>{item.title || 'Plumbing Analysis'}</strong>
              ...
              <div className="stack-sm">
                <div className="form-group">
                  ...
                  <input
                    ...
                    placeholder="e.g. Kitchen drain backup"
              ...
              <div className="stack-sm">
                <div className="form-group">
                  ...
                  <input
                    className="input"
                    value={editValues[item.id]?.title || ''}
                    placeholder="e.g. Basement sump pump failure"
                    onChange={(e) => setEditValues((prev) => ({ ...prev, [item.id]: { ...prev[item.id], title: e.target.value } }))}
                  />
                </div>
                <div className="form-group">
  ...
  return (
    <div className="page">
      ...
      {!loading && tab === 'analyses' && (
        analyses.length === 0
          ? <p className="text-center text-secondary" style={{ padding: '2rem 0' }}>No plumbing analyses yet.</p>
