// Generate and seed training questions for PipePal via Claude API
...
async function main() {
  console.log("=== Seeding PipePal Training Questions ===\n");
