...
const CATEGORIES = [
  { id: 'pipe_sizing', label: 'Pipe Sizing', icon: '\uD83D\uDD27' },
  { id: 'pipe_materials', label: 'Pipe Materials', icon: '\uD83E\uDDF1' },
  { id: 'gas_piping', label: 'Gas Piping', icon: '\uD83D\uDD25' },
  { id: 'code_requirements', label: 'Code Requirements', icon: '\uD83D\uDCD6' },
  { id: 'backflow', label: 'Backflow', icon: '\uD83D\uDCA7' },
  { id: 'safety', label: 'Safety', icon: '\u26A0' },
  { id: 'fixture_install', label: 'Fixture Install', icon: '\uD83D\uDEBF' },
  { id: 'venting', label: 'Venting', icon: '\uD83C\uDF2C' },
